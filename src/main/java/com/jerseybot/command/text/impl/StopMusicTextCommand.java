...
@Component
public class StopMusicTextCommand extends AbstractTextCommand {
    private final PlayerRepository playerRepository;

    @Autowired
    public StopMusicTextCommand(PlayerRepository playerRepository) {
